...
public class ReviewPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Review weddingcrashers = reviewRepo.save(new Review("Wedding Crashers",
				"Jeremy (Vince Vaughn) and John (Owen Wilson) are divorce mediators who spend their free time crashing wedding receptions. For the irrepressible duo, there are few better ways to drink for free and bed vulnerable women.",
		...
		Review ghostbusters = reviewRepo.save(new Review("Ghost Busters",
				"Parapsychologists Peter Venkman, Raymond Stantz, and Egon Spengler are scientists working for Columbia University. After they lose their jobs, they establish the Ghostbusters, a paranormal investigation and elimination service.",
				"/img/GhostbustersPoster.jpg", comedy));

		Review back2future = reviewRepo.save(new Review("Back To The Future",
				"After being accidentally sent 30 years into the past in a time-travelling DeLorean invented by mad scientist Dr. Emmett Brown, teenager Marty McFly has to find a way to return to the future safely.",
				"/img/back.jpg", comedy));

		Review capnAmerica = reviewRepo.save(new Review("Captain America",
				"Set predominantly during World War II, Captain America: The First Avenger tells the story of Steve Rogers, a sickly man from Brooklyn who is transformed into super-soldier Captain America and must stop the Red Skull.",
		...
		Review shawShank = reviewRepo.save(new Review("Shawshank Redemption",
				"Adapted from the Stephen King novella Rita Hayworth and Shawshank Redemption, the film tells the story of Andy Dufresne, a banker who spends 19 years in Shawshank State Prison for the murder of his wife and her lover despite his claims of innocence.",
		...
		Review theShining = reviewRepo.save(new Review("The Shining",
				"The only thing that can save Danny and his mother is \"The Shining\". Jack Torrance becomes the caretaker of the Overlook Hotel up in the secluded mountains of Colorado. Jack, being a family man, takes his wife and son to the hotel to keep him company throughout the long and isolated nights.",
				"/img/shining.jpg", horror));
		
		Review theRing = reviewRepo.save(new Review("the Ring",
				"The Ring (stylized as the ring) is a 2002 American supernatural horror film directed by Gore Verbinski and starring Naomi Watts, Martin Henderson, David Dorfman, Brian Cox and Daveigh Chase. It is a remake of the 1998 Japanese horror film Ring based on the novel of the same name by Koji Suzuki.",
				"/img/ring.jpg", horror));
		...
		Review grandTorino = reviewRepo.save(new Review("Grand Torino",
				"He is a Korean War veteran whose prize possession is a 1972 Gran Torino he keeps in mint condition. When his neighbor Thao, a young Hmong teenager under pressure from his gang member cousin, tries to steal his Gran Torino, Kowalski sets out to reform the youth.",
